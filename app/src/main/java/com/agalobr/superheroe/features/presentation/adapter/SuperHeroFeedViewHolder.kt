...
class SuperHeroFeedViewHolder(binding: ViewSuperheroFeedItemBinding): RecyclerView.ViewHolder(binding.root) {

    private val binding = ViewSuperheroFeedItemBinding.bind(binding.root)

    fun bind(superHero: SuperHeroesFeedUseCase.SuperHeroeList){
